<%@ Page Title="" Language="C#" MasterPageFile="~/Volunteer/VolunteerMasterPage.master" AutoEventWireup="true" CodeFile="ShowNotice.aspx.cs" Inherits="Volunteer_ShowNotice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
    CellPadding="20" CellSpacing="1" DataKeyNames="id" 
    DataSourceID="SqlDataSource1" ForeColor="#333333" Height="50%" Width="100%">
